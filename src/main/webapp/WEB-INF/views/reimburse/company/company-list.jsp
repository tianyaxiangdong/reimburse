...
<body>
<form action="/company/company-list" method="post">
<table>
  <tr>
...
<table style="border:solid 1px #add9c0;" class="td">
  ...
  <c:forEach var="company"  items="${list_company}">
    <tr>
      <td><a href="/company/company-edit?companyId=${company.companyId}">修改</a></td>
      <td>${company.companyName}</td>
      <td>${company.companyJsTypeId}</td>
      <td>${company.companyLxr}/${company.companyLxdh}</td>
